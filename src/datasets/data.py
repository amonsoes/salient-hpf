...
from src.datasets.subsets import FlickrSubset, FlickrSubsetWithPath, AugmentedFlickrSubset, Nips17Subset, CustomCIFAR100, CustomCIFAR10
...
class CIFAR10Dataset(BaseDataset):
    ...
    def get_data(self):
        ...
        test_data = CustomCIFAR10(adversarial=self.adversarial_opt.adversarial, is_test_data=True, root='./data', train=False, download=True, transform=self.transforms.transform_val)
        return train_val_data, test_data
